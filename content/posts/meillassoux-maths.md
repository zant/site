...
_The interpretations and analyses presented in this paper are entirely my own and do not necessarily reflect the views of the author_
...
4. S = P(P(S)). Let S now be this power set
5. P(P(P(S))
6. ...
